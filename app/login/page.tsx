 ...
 *
 * Displays the Google OAuth sign-in button.
 * - If the user is already authenticated, they are redirected to the dashboard.
 * - The form POSTs to /auth/google, which initiates the OAuth flow via Supabase.
 *
 * This is a Server Component — auth check happens server-side before rendering.
 */
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] flex flex-col items-center justify-center px-6">
      <div className="w-full max-w-xs">
        ...
        {/* Google OAuth form — POSTs to /auth/google which triggers Supabase OAuth */}
        <form action="/auth/google" method="post">
          ...
          >
            {/* Google "G" icon (monochrome to match the minimalist theme) */}
